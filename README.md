...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/steset)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/steset
```

A live public deployment of this template is available at [https://steset.templates.workers.dev](https://steset.templates.workers.dev)
